 ...
 */
final class WindowExtendedStyle
{
    /**
     ...
     * dwStyle parameter.
     */
    public const WS_EX_DLGMODALFRAME = 0x0000_0001;
     ...
     * or destroyed.
     */
    public const WS_EX_NOPARENTNOTIFY = 0x0000_0004;
     ...
     */
    public const WS_EX_TOPMOST = 0x0000_0008;

    /**
     * The window accepts drag-drop files.
     */
    public const WS_EX_ACCEPTFILES = 0x0000_0010;
     ...
     * function.
     */
    public const WS_EX_TRANSPARENT = 0x0000_0020;

    /**
     * The window is a MDI child window.
     */
    public const WS_EX_MDICHILD = 0x0000_0040;
     ...
     * typing ALT+SPACE.
     */
    public const WS_EX_TOOLWINDOW = 0x0000_0080;

    /**
     * The window has a border with a raised edge.
     */
    public const WS_EX_WINDOWEDGE = 0x0000_0100;

    /**
     * The window has a border with a sunken edge.
     */
    public const WS_EX_CLIENTEDGE = 0x0000_0200;
     ...
     */
    public const WS_EX_CONTEXTHELP = 0x0000_0400;
     ...
     */
    public const WS_EX_RIGHT = 0x0000_1000;

    /**
     * The window has generic left-aligned properties. This is the default.
     */
    public const WS_EX_LEFT = 0x0000_0000;
     ...
     * ignored.
     */
    public const WS_EX_LEFTSCROLLBAR = 0x0000_4000;

    /**
     * The vertical scroll bar (if present) is to the right of the client area.
     * This is the default.
     */
    public const WS_EX_RIGHTSCROLLBAR = 0x0000_0000;
     ...
     */
    public const WS_EX_CONTROLPARENT = 0x0001_0000;

    /**
     * The window has a three-dimensional border style intended to be used for
     * items that do not accept user input.
     */
    public const WS_EX_STATICEDGE = 0x0002_0000;

    /**
     * Forces a top-level window onto the taskbar when the window is visible.
     */
    public const WS_EX_APPWINDOW = 0x0004_0000;
     ...
     */
    public const WS_EX_LAYERED = 0x0008_0000;

    /**
     * The window does not pass its window layout to its child windows.
     */
    public const WS_EX_NOINHERITLAYOUT = 0x0010_0000;
     ...
     */
    public const WS_EX_NOREDIRECTIONBITMAP = 0x0020_0000;
     ...
     */
    public const WS_EX_LAYOUTRTL = 0x0040_0000;
     ...
     */
    public const WS_EX_COMPOSITED = 0x0200_0000;
     ...
     */
    public const WS_EX_NOACTIVATE = 0x0800_0000;

    /**
     * The window is an overlapped window.
     */
    public const WS_EX_OVERLAPPEDWINDOW = self::WS_EX_WINDOWEDGE
     ...
     */
    public const WS_EX_PALETTEWINDOW = self::WS_EX_WINDOWEDGE
