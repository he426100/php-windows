...
final class WindowClassStyle
{
     ...
     * to the class.
     */
    public const CS_DBLCLKS = 0x0008;

    /**
     * Allocates a unique device context for each window in the class.
     */
    public const CS_OWNDC = 0x0020;
     ...
     */
    public const CS_CLASSDC = 0x0040;
     ...
     */
    public const CS_PARENTDC = 0x0080;

    /**
     * Disables Close on the window menu.
     */
    public const CS_NOCLOSE = 0x0200;
     ...
     */
    public const CS_SAVEBITS = 0x0800;
     ...
     * on the display.
     */
    public const CS_BYTEALIGNCLIENT = 0x1000;
     ...
     * display.
     */
    public const CS_BYTEALIGNWINDOW = 0x2000;
     ...
     */
    public const CS_GLOBALCLASS = 0x4000;
     ...
     */
    public const CS_IME = 0x00010000;
     ...
     */
    public const CS_DROPSHADOW = 0x00020000;
}
